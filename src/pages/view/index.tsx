...
import { ArrowLeft, Calendar, CheckCircle, Clock, XCircle, FileText } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900">View Requests</h1>
            </div>
          </div>
        </div>
      </header>
                ...
                <tbody>
                  {requests.map((request, index) => (
                    <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4">
                        <span className={`inline-flex items-center gap-1 px-3 py-1 text-sm font-medium rounded-full capitalize ${getStatusColor(request.status)}`}>
